...
public class CustomerCheckManager implements ICustomerCheckService{
	...
	@Override
	public boolean checkCustomerInfo(Customer customer) {
		return isTCKN(customer.getNationalityId());
	}
	
	//MERNIS dogrulamayý yapamadým bende böyle bir çözüm ürettim
	//https://gist.github.com/murataygun/d4f9c3bdfe13e69f5fae17a48c467c98#file-tcknvalidate-java dogrulama kodlarý burdan alýnmýþtýr.
	public boolean isTCKN(String tckn) {
